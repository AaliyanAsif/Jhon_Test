      ...
      <section className="py-16 bg-white dark:bg-secondary-800">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-primary-50 dark:bg-primary-950/40 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
            ...
            {team.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-secondary-600 dark:text-secondary-300 text-sm">{member.bio}</p>
                </div>
              </motion.div>
            ))}
          </div>
