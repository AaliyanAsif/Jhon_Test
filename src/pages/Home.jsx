          ...
          {investmentSteps.map((step, index) => (
            ...
            >
              <div className="bg-white dark:bg-secondary-800 p-6 rounded-lg shadow-md text-center">
                <div className="bg-primary-50 dark:bg-primary-950/40 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="container">
        <div className="bg-primary-600 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/properties"
              className="btn bg-white text-primary-600 hover:bg-primary-50 dark:bg-white dark:text-primary-700 dark:hover:bg-primary-50"
            >
              Browse Properties
            </Link>
            <ConnectWalletButton variant="cta" showIcon />
          </div>
        </div>
      </section>
