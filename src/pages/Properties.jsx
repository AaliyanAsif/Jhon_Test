        ...
        <div className="container py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-md ${showFilters ? 'bg-primary-100 text-primary-600 dark:bg-primary-950/40 dark:text-primary-400' : 'hover:bg-secondary-100 dark:hover:bg-secondary-700'}`}
